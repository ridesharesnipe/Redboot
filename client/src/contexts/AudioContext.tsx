...
export function AudioProvider({ children }: { children: ReactNode }) {
  ...
  const playCharacterVoice = (voiceType: CharacterVoiceType) => {
    ...
    // Kid-friendly pirate phrases - reduced name usage for less repetition
    const characterPhrases: Record<CharacterVoiceType, string[]> = {
      red_boot_ahoy: [
        ...
        `Welcome to the ship! Ready for adventure?`,
      ...
      red_boot_adventure_complete: [
        ...
        `You're a true spelling champion!`,
        ...
        `The crew cheers for you!`,
        `Victory is yours, Captain!`
      ],
      ocean_blue_encouraging: [
        `Keep going! The treasure is close!`,
        `You're doing great!`,
      ...
      red_boot_retry: [
        `Let's try those tricky words again!`,
        `Time for round two!`,
