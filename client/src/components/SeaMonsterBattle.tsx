...
const DEFAULT_MONSTER_NODES: Omit<SeaMonsterNode, 'isDefeated' | 'isBattling' | 'isRevealed'>[] = [
  { id: 'monster-1', x: 5, y: 78, monsterType: SeaMonsterType.SHARK, wordIndex: 0 },
  ...
  { id: 'monster-4', x: 10, y: 8, monsterType: SeaMonsterType.SEA_DRAGON, wordIndex: 3 },
  ...
  { id: 'monster-7', x: 62, y: 10, monsterType: SeaMonsterType.MEGALODON, wordIndex: 6 },
