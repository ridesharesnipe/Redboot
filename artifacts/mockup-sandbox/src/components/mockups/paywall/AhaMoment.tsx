...
export function AhaMoment() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #e8f4ff 0%, #fff8f0 50%, #fef3e2 100%)", fontFamily: "'Plus Jakarta Sans', sans-serif", overflowY: "auto" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #1A6BC4 0%, #0E4B8F 100%)", padding: "28px 20px 40px", position: "relative", overflow: "hidden" }}>
        ...
        <h1 style={{ fontFamily: "'Fredoka One', cursive", fontSize: 26, color: "white", margin: 0, lineHeight: 1.2 }}>
        ...
        <div style={clay.card}>
          <div style={{ padding: "20px 18px" }}>
            ...
            <div
              ...
              style={{ padding: "14px 16px", borderRadius: 16, border: selectedPlan === "monthly" ? "2px solid #534AB7" : "1.5px solid #e2e8f0", background: selectedPlan === "monthly" ? "linear-gradient(145deg, #f5f3ff, #ede9fe22)" : "white", cursor: "pointer", marginBottom: 16, display: "flex", justifyContent: "space-between", alignItems: "center" }}
            >
              <div>
            ...
            <input
              ...
              style={{ width: "100%", padding: "12px 14px", borderRadius: 12, border: "1.5px solid #e2e8f0", fontSize: 14, marginBottom: 12, boxSizing: "border-box", fontFamily: "inherit", outline: "none" }}
            />
